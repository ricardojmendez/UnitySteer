...
/// 
/// If you use a too high estimation time compared to the movement tick,
/// changes are the calculation will overshoot the obstacle and it won't
/// notice an impending collision.
/// </remarks>
