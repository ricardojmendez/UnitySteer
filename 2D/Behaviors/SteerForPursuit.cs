...
namespace UnitySteer2D.Behaviors
{
    ...
    /// </summary>
    [AddComponentMenu("UnitySteer2D/Steer/... for Pursuit")]
    public class SteerForPursuit : Steering
    {
        ...
        [SerializeField] private Vehicle _quarry; //why detectableobject? Makes more sense to just make it a vehicle and so have access to the new Forward vector.
